...
# Load mix data
mix.filename <- system.file("MixSIAR_Sept4_Consumer.csv", package = "MixSIAR")
...
# Load source data
source.filename <- system.file("MixSIAR_Sept4_Source.csv", package = "MixSIAR")
...
discr.filename <- system.file("MixSIAR_Sept4_Discrimination.csv", package = "MixSIAR")
...
kw.alpha <- c(0.04,2.16,0.81,0.99)
