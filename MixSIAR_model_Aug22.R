...
# Load mix data
mix.filename <- system.file("MixSIAR_Aug22_Consumer.csv", package = "MixSIAR")
...
# Load source data
source.filename <- system.file("MixSIAR_Aug22_Source.csv", package = "MixSIAR")
...
discr.filename <- system.file("MixSIAR_Aug22_Discrimination.csv", package = "MixSIAR")
...
kw.alpha <- c(0.05,2.13,1.02,0.80)
