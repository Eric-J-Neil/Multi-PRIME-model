...
# Load mix data
mix.filename <- system.file("MixSIAR_Aug29_Consumer.csv", package = "MixSIAR")
...
# Load source data
source.filename <- system.file("MixSIAR_Aug29_Source.csv", package = "MixSIAR")
...
discr.filename <- system.file("MixSIAR_Aug29_Discrimination.csv", package = "MixSIAR")
...
kw.alpha <- c(0.05,2.15,1.06,0.74)
